...
- [pcbDocuments](pcbDocuments)
    ...
    - [Печатная плата](pcbDocuments/pdfDocuments/PP.pdf)
    - [Сборочный чертеж ячейки](pcbDocuments/pdfDocuments/SB.pdf)
    - [Спецификация](pcbDocuments/pdfDocuments/Spec.pdf)
    - [Сборочный чертеж корпуса](pcbDocuments/pdfDocuments/SB_corpus.pdf)
...
- [pcbCase](pcbCase)
    ...
    - [battery case.ipt](pcbCase/case18650/case18650.ipt)
    - [fixation for motor.ipt](pcbCase/soporte_plastico/soporte_plastico.ipt)
    - [lidar.ipt](pcbCase/lidar/lidar.ipt)
    - [wheel.ipt](pcbCase/wheel/Wheel.ipt)
    - [motor.ipt](pcbCase/motor/motor.ipt)
    - [sborka](pcbCase/pcbCase/sborka.iam)
